...
def fetch_graph_data():
    ...
    nodes = [{"id": "1", "title": "Service1","color":"red"},
             {"id": "2", "title": "Service2","color":"red"},
             {"id": "3", "title": "Service3","color":"red"},
             {"id": "4", "title": "Service3","color":"red"},
             {"id": "5", "title": "Service4","color":"red"}]
